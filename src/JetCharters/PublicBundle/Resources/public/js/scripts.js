$(document).ready(function(){
	...
	if ($('.datepicker').exists()) {
		$( "#from" ).datepicker({
			...
			buttonImage: "/bundles/jetcharterspublic/images/ico-datepicker.png",
			...
			beforeShow: function(input, inst)
		    {
				...
				setTimeout(function(){
					console.log($(input_).offset().top + ' aaaa ' + $(inst_.dpDiv).css('top'))
					if ($(input_).offset().top>parseInt($(inst_.dpDiv).css('top'))){
						$(inst.dpDiv).addClass('upper');
					}
					else {
						$(inst.dpDiv).removeClass('upper');
